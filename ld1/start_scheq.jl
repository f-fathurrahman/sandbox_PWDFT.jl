...
function start_scheq!(lam::Int64, e, b, grid::RadialGrid, Zval, solution)
    #
    ...
    rr1 = (1.0 + grid.r[1]*(c1 + grid.r[1]*(c2 + grid.r[1]*(c3 + grid.r[1]*c4))))*grid.r[1]^l1
    rr2 = (1.0 + grid.r[2]*(c1 + grid.r[2]*(c2 + grid.r[2]*(c3 + grid.r[2]*c4))))*grid.r[2]^l1
