...
function main( init_func; fnametrj="TRAJ.xyz", fnameetot="ETOT.dat" )
    ...
    for iter = 1:NiterMax
        ...
        if iter > iter_start_XL
            ...
            Serialization.serialize("phi_m1.dat", phi_m1[1])
            Serialization.serialize("phi_m2.dat", phi_m2[1])
            Serialization.serialize("phi_m3.dat", phi_m3[1])
            Serialization.serialize("phi_m4.dat", phi_m4[1])
            Serialization.serialize("phi_m5.dat", phi_m5[1])
